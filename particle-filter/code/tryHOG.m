...
pigMode = 1   % Use 1 or 2  (for contrasty pigeon or bland pigeon, resp)
marking = 0   % Use 0 or 1 (for back marking, or head, resp)
...
[seqRoot 'pigClone' num2strPad(frameNum, 4) '.pgm']
