%% Cell finder V0.1 (A2 2503 2013F)
%  Code from DJF and ADJ. 
...
hmdir = '/Users/ansonliang55/Dropbox/UOT/CSC2503/matlab/A2handout/cellFinder/';
...
minNumPts = 15;    % Min number of data edgels to bother fitting
...
interactive = false;  % Set to false to run in batch
...
for iFname = 1:1  % Use 1 image for now, change to 1:nFname to process all
